class level2 extends Phaser.Scene {
  ...
  create() {
    ...
    this.heart = this.physics.add.sprite(heart.x, heart.y, "heart").setScale(0.03)
    this.heart2 = this.physics.add.sprite(heart2.x, heart2.y, "heart2").setScale(0.03)

    this.battery = this.physics.add.sprite(battery.x, battery.y, "battery").setScale(0.05)
    this.battery2 = this.physics.add.sprite(battery2.x, battery2.y, "battery2").setScale(0.05)
    this.battery3 = this.physics.add.sprite(battery3.x, battery3.y, "battery3").setScale(0.05)
